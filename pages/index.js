    ...
    <div className='bg-blue-50 mx-20 mt-20'>
      <div className='flex items-center justify-center m-4'>
        <input
          ...
          <button className='m-4 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-full shadow-md transition duration-300 ease-in-out' onClick={() => fetchFunction(inputVal)}>
            Search
          </button>
      </div>
